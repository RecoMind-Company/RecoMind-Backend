...
//    {
//        private readonly Mock<IUnitOfWork<SubscriptionCompany>> _mockUnitOfWork;
//        private readonly Mock<IMapper> _mockMapper;
//        private readonly Mock<ISubscriptionTypeService> _mockSubscriptionTypeService;
//        public SubscriptionServiceTests()
//        {
//            _mockUnitOfWork = new Mock<IUnitOfWork<SubscriptionCompany>>();
//            _mockMapper = new Mock<IMapper>();
//            _mockSubscriptionTypeService = new Mock<ISubscriptionTypeService>();

//            var mockRepository = new Mock<IGenericRepository<SubscriptionCompany>>();
...
//        {
//            // Arrange
//            var createDto = new CreateSubscriptionCompanyDto { PlanName = "Pro", BillingCycle = "Monthly" };

//            var subscriptionModel = new SubscriptionCompany { Price = 2000, StartDate = DateTime.Now, EndDate = DateTime.Now.AddMonths(1) };

//            var expectedGetDto = new GetSubscriptionCompanyDto { PlanName = "Pro" };

//            _mockMapper.Setup(m => m.Map(createDto, It.IsAny<SubscriptionCompany>())).Returns(subscriptionModel);
//            _mockMapper.Setup(m => m.Map<GetSubscriptionCompanyDto>(It.IsAny<SubscriptionCompany>())).Returns(expectedGetDto);

//            // Act
//            var result = await _.CreateSubscription(createDto);
...
//            var expectedDto = new GetSubscriptionCompanyDto { Id = subscriptionId };

//            _mockUnitOfWork.Setup(u => u.Entity.GetByIdAsync(subscriptionId))
//                           .ReturnsAsync(subscriptionModel);

//            _mockMapper.Setup(m => m.Map<GetSubscriptionCompanyDto>(subscriptionModel))
//                       .Returns(expectedDto);
...
//            var updateDto = new CreateSubscriptionCompanyDto { PlanName = "Pro", BillingCycle = "SemiAnnual" };
...
//            var expectedUpdateDto = new UpdateSubscriptionCompanyDto { Id = subscriptionId, PlanName = "Pro" };
...
//            _mockMapper.Setup(m => m.Map<UpdateSubscriptionCompanyDto>(It.IsAny<Subscription>()))
...
//            // Arrange
//            var nonExistentId = Guid.NewGuid().ToString();
//            var updateDto = new CreateSubscriptionCompanyDto { PlanName = "Pro", BillingCycle = "Monthly" };
...
//        {
//            // Arrange
//            CreateSubscriptionCompanyDto subscriptionDto = dto == "dto" ? new CreateSubscriptionCompanyDto() : null;
...
//            var subscriptionId = Guid.NewGuid().ToString();
//            var subscriptionModel = new Subscription { Id = subscriptionId};
//            var expectedDeleteDto = new DeleteSubscriptionCompanyDto { Id = subscriptionId };
...
//            _mockMapper.Setup(m => m.Map<DeleteSubscriptionCompanyDto>(subscriptionModel))
